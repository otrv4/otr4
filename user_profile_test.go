...
func (s *OTR4Suite) Test_SerializeTransitionalSignature(c *C) {
...
func (s *OTR4Suite) Test_SignUserProfile(c *C) {
	...
	sig, err := profile.sign(fixedRand(csRandData), keyPair)
	...
	sig, err = profile.sign(fixedRand([]byte{0x00}), keyPair)
