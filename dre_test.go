...
var (
	...
	testScalar = ed448.NewDecafScalar([56]byte{
...
func (s *DualReceiverEncryptionSuite) Test_Concat(c *C) {
	...
	c.Assert(concat(empty, bytes, testScalar, testPoint), DeepEquals, exp)
}
...
func (s *DualReceiverEncryptionSuite) Test_Auth(c *C) {
	...
	sigma := auth(fixedRand, testPoint, p2, p3, secA, message)
